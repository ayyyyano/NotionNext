...
const BLOG = {
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20262514号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20262514', // 备案查询链接，如果用了萌备等备案请在这里填写
